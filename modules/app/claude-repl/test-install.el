...
(ert-deftest claude-repl-test-managed-local-skills-includes-workspace-open ()
...
handler dispatches against to re-establish a closed/nuked workspace."
  (should (member "workspace-open" claude-repl--managed-local-skills)))
...
(ert-deftest claude-repl-test-workspace-open-skill-file-exists ()
...
(ert-deftest claude-repl-test-workspace-open-run-sh-executable ()
