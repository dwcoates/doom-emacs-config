...
(defcustom claude-repl-command-prefix
  (concat "\n"
          ...
          "instead add it as a subbullet of the bullet. Always use subbullets instead of semicolons or emdashes. Always include a brief TLDR summary of changes as you would for analysis. "
