...
(defcustom claude-repl-command-prefix
  (concat "\n"
          ...
          "end (as though it were a simple short-answer request). Always include a brief TLDR summary of changes as you would for analysis. "
          "Regardless of the response (unless the response is 1-5 sentences long), ALWAYS provide a brief 'TLDR' section as the last thing in the final response. Always. "
          "\n"
