...
(defcustom claude-repl-command-prefix
  (concat "\n"
          ...
          "The ordering of trailing sections is therefore: (1) 'large context TLDR' first, (2) 'last response TLDR' second, (3) 'TLDR's TLDR' last. "
          "\n"
          "* After the 'last response TLDR' section, ALWAYS include a 'TLDR's TLDR' section as the VERY LAST item in the response. "
          ...
          "response is 1-5 sentences long. This is non-negotiable and must always be the final section of any response that has TLDRs. "
          "\n"
