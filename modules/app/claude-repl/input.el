...
(defcustom claude-repl-command-prefix
  (concat "\n"
          ...
          "\n"
          "* Regardless of the response (unless the response is 1-5 sentences long), ALWAYS provide a single 'Response TLDR' section "
          "at the very end of the response, following the TLDR spec below. This must be the VERY LAST section of the response. "
          "\n"
          "* TLDR spec: "
          "\n"
          ...
          "\n"
          "  - Always use subbullets instead of semicolons, emdashes, or second sentences. "
          "\n"
          ...
          "\n"
          "  - The 1-5 sentence exception: skip the Response TLDR entirely only when the response is 1-5 sentences long. "
          "\n"
