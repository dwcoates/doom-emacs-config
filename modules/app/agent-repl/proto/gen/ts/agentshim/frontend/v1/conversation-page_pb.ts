...
// @generated from file agentshim/frontend/v1/conversation-page.proto (package agentshim.frontend.v1, syntax proto3)
/* eslint-disable */
 ...
 *
 * @generated from message agentshim.frontend.v1.ConversationPageCmd
 */
export type ConversationPageCmd = Message<"agentshim.frontend.v1.ConversationPageCmd"> & {
  /**
   * @generated from oneof agentshim.frontend.v1.ConversationPageCmd.anchor
   */
  anchor: {
    /**
     * The cold open: the newest end of the conversation.
     *
     * @generated from field: agentshim.frontend.v1.ConversationPageTail tail = 1;
     */
    value: ConversationPageTail;
    case: "tail";
  } | {
    /**
     * Load-more: the page immediately older than one already held.
     *
     * @generated from field: agentshim.frontend.v1.ConversationPageBefore before = 2;
     */
    value: ConversationPageBefore;
    case: "before";
...
/**
 * Describes the message agentshim.frontend.v1.ConversationPageCmd.
 * Use `create(ConversationPageCmdSchema)` to create a new message.
 */
...
/**
 * Describes the message agentshim.frontend.v1.ConversationPageTail.
...
export const ConversationPageTailSchema: GenMessage<ConversationPageTail> = /*@__PURE__*/
  messageDesc(file_agentshim_frontend_v1_conversation_page, 1);

/**
 * The load-more anchor: start immediately older than a previously served page.
 *
 * @generated from message agentshim.frontend.v1.ConversationPageBefore
 */
export type ConversationPageBefore = Message<"agentshim.frontend.v1.ConversationPageBefore"> & {
  /**
...
/**
 * Describes the message agentshim.frontend.v1.ConversationPageBefore.
...
export const ConversationPageBeforeSchema: GenMessage<ConversationPageBefore> = /*@__PURE__*/
  messageDesc(file_agentshim_frontend_v1_conversation_page, 2);
 ...
 * famously did.
 *
 * @generated from message agentshim.frontend.v1.ConversationPage
 */
export type ConversationPage = Message<"agentshim.frontend.v1.ConversationPage"> & {
  /**
   ...
   *
   * @generated from oneof agentshim.frontend.v1.ConversationPage.continuation
   */
  continuation: {
    /**
     * Older history remains; the cursor reads the page before this one.
     *
     * @generated from field: agentshim.frontend.v1.ConversationPageMore more = 4;
     */
    value: ConversationPageMore;
    case: "more";
  } | {
    /**
     * This page reaches the conversation's beginning.
     *
     * @generated from field: agentshim.frontend.v1.ConversationPageStart start = 5;
     */
    value: ConversationPageStart;
    case: "start";
  } | { case: undefined; value?: undefined };
...
/**
 * Describes the message agentshim.frontend.v1.ConversationPage.
...
export const ConversationPageSchema: GenMessage<ConversationPage> = /*@__PURE__*/
  messageDesc(file_agentshim_frontend_v1_conversation_page, 3);

/**
 * There is older history, and this is how to ask for it.
 *
 * @generated from message agentshim.frontend.v1.ConversationPageMore
 */
export type ConversationPageMore = Message<"agentshim.frontend.v1.ConversationPageMore"> & {
  /**
...
/**
 * Describes the message agentshim.frontend.v1.ConversationPageMore.
...
export const ConversationPageMoreSchema: GenMessage<ConversationPageMore> = /*@__PURE__*/
  messageDesc(file_agentshim_frontend_v1_conversation_page, 4);
 ...
 *
 * @generated from message agentshim.frontend.v1.ConversationPageStart
 */
export type ConversationPageStart = Message<"agentshim.frontend.v1.ConversationPageStart"> & {
};

/**
 * Describes the message agentshim.frontend.v1.ConversationPageStart.
...
export const ConversationPageStartSchema: GenMessage<ConversationPageStart> = /*@__PURE__*/
  messageDesc(file_agentshim_frontend_v1_conversation_page, 5);
