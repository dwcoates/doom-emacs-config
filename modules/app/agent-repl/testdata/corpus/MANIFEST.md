...
| `attachments/queued_command.jsonl` | `~/.claude-chesscom/projects/<project>/<session>.jsonl` | AttachmentLine.QueuedCommandAttachment | shortest real sample; structural fields intact |
