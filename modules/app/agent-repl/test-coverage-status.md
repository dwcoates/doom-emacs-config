...
### `agent-repl--ws-clear-if-status` / `agent-repl--ws-clear` (lines 20-30)
...
### `agent-repl--workspace-clean-p` (line 40)
...
### `agent-repl--git-check-in-progress-p` (line 47)
...
### `agent-repl--git-diff-sentinel` (line 52)
...
### `agent-repl--async-refresh-git-status` (line 65)
...
### `agent-repl--workspace-for-buffer` (line 86)
...
### `agent-repl--status-color` (line 114)
...
### `agent-repl--render-tab` (line 143)
...
### `agent-repl--render-selected-tab` (line 154)
...
### `agent-repl--render-unselected-tab` (line 169)
...
### `agent-repl--tab-face` (line 186)
Returns face symbol or fallback.

| Edge case | Covered? | Test |
|-----------|----------|------|
| :thinking -> agent-repl-tab-thinking | Indirectly | `tabline-thinking-face` |
| :done -> agent-repl-tab-done | Indirectly | `tabline-done-face` |
| :inactive -> agent-repl-tab-inactive | Indirectly | `tabline-inactive-face` |
| :permission -> agent-repl-tab-permission | Indirectly | `tabline-selected-shows-permission` |
...
### `agent-repl--tab-priority-image-str` (line 193)
...
### `agent-repl--render-tab-entry` (line 199)
...
### `agent-repl--tabline-advice` (line 212)
...
### `agent-repl--wconf-has-claude-p` (line 234)
...
### `agent-repl--visible-claude-buffer-p` (line 244)
...
### `agent-repl--claude-visible-in-current-ws-p` (line 250)
...
### `agent-repl--claude-in-saved-wconf-p` (line 255)
...
### `agent-repl--ws-claude-open-p` (line 261)
...
### `agent-repl--panels-actively-visible-p` (line 269)
...
### `agent-repl--update-ws-state` (line 278)
...
### `agent-repl--update-all-workspace-states` (line 303)
...
### `agent-repl--maybe-clear-stale-state` (line 323)
...
### `agent-repl--on-frame-focus` (line 334)
