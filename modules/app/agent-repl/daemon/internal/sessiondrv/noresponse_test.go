...
func TestANoResponsePlaceholderIsWithheldFromTheFeed(t *testing.T) {
	...
	// Act
	h.driver().consumer.Consume(transcriptAssistantTextEvent(t, 12, "a-placeholder", syntheticModel, noResponseRequestedText))
...
func TestARealAnswerBesideAPlaceholderStillReachesTheFeed(t *testing.T) {
	...
	// Act
	h.driver().consumer.Consume(transcriptAssistantTextEvent(t, 12, "a-placeholder", syntheticModel, noResponseRequestedText))
	h.driver().consumer.Consume(transcriptAssistantTextEvent(t, 13, "a-real", "claude-fable-5", "here is the answer"))
...
func TestASyntheticApiFailureCardStillReachesTheFeed(t *testing.T) {
	...
	// Act
	h.driver().consumer.Consume(transcriptAssistantTextEvent(t, 12, "a-ratelimit", syntheticModel,
...
func TestAWithheldPlaceholderStillAdvancesTheSeq(t *testing.T) {
	...
	if got := h.driver().consumer.newestRetainedSeq(); got != 12 {
...
func TestAReplayedPlaceholderIsWithheldToo(t *testing.T) {
	...
	// Act
	h.driver().consumer.pushConversation(transcriptAssistantTextEvent(t, 12, "a-placeholder", syntheticModel, noResponseRequestedText), false)
