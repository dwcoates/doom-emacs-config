...
func TestARealPromptBesideMachineryStillReachesTheFeed(t *testing.T) {
	...
	// Act
	h.driver().consumer.Consume(transcriptUserEvent(t, 12, "u-machinery", compactMachinery))
	h.driver().consumer.Consume(transcriptUserEvent(t, 13, "u-real", "carry on"))
...
func TestAMachineryLineDoesNotRaiseTheReplayFloor(t *testing.T) {
	...
	// Assert
	if seq := h.driver().consumer.floors.NewestClearOrCompactSeq("s1"); seq != 0 {
...
func TestTheRealLineIsStillAttributedAfterAMachineryLine(t *testing.T) {
	...
	// Act
	h.driver().consumer.Consume(transcriptUserEvent(t, 12, "u-machinery", compactMachinery))
	h.driver().consumer.Consume(transcriptUserEvent(t, 13, "u-real", "hello there"))
...
func TestAReplayedMachineryLineIsWithheldToo(t *testing.T) {
	...
	// Act
	h.driver().consumer.pushConversation(transcriptUserEvent(t, 12, "u-machinery", compactMachinery), false)
...
func TestMachineryOnTheStreamPlaneIsWithheldToo(t *testing.T) {
	...
	// Act
	h.driver().consumer.Consume(machineryStreamEvent(t, 12, compactMachinery))
