...
// turnActiveFlag reads the session controller's observed turn boundary under the manager
// lock. The controller is resolved FIRST because existing() takes the same lock.
