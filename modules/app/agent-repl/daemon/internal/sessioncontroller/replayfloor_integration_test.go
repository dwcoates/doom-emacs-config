...
// floorHarness is one live session controller over a caller-chosen client, with the floor
...
// consumer returns the live session controller's consumer, the sink a shim's demux feeds.
